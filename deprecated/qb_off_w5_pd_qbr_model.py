"""
QB offensive formation EPA (w3) + point differential + QBR (w5 team equivalent).
Train 2016-2021, test 2022-2025.
Rank 7 E>3: 55.8% (n=258), +16.9u. Overall ATS: 53.0% (n=513), +6.3u.
Note: uses the same QB rolling features as qb_off_pd_qbr_model.py;
listed separately because it corresponds to the w5-window team equivalent.
"""
