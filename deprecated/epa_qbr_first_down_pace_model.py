"""
EPA + QBR + offensive 1st down EPA + pace model.
Train 2006-2021, test 2022-2025.
Note: rows missing QBR are dropped via build_dataset dropna.
"""

from sklearn.linear_model import LinearRegression
from src.data_loader import get_schedule_data
from src.model_utils import TRAIN_SEASONS, TEST_SEASONS, load_features, build_dataset, evaluate
from config import SEASONS

FEATURE_COLS = ["off_epa_rolling", "def_epa_rolling", "qbr_rolling",
