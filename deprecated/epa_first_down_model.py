"""
EPA + first down EPA model: full rolling EPA combined with 1st down EPA.
...
FEATURE_COLS = ["off_epa_rolling", "def_epa_rolling", "off_epa_first_down_rolling", "def_epa_first_down_rolling"]
