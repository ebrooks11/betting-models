"""
QB offensive formation EPA + defensive EPA + point differential + QBR + CPOE.
Train 2016-2021, test 2022-2025.
Rank 1 E>3: 57.0% (n=263), +23.4u. Overall ATS: 52.2% (n=513), -1.4u.
Best model for selective high-confidence E>3 betting (QB-only features).
"""
