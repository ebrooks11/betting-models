"""
Combined team (w5 window) + QB offensive formation EPA + point differential + QBR.
Train 2016-2021, test 2022-2025.
Rank 10 E>3: 55.3% (n=244), +13.7u. Overall ATS: 53.4% (n=513), +10.1u.
"""
...
FEATURE_COLS = [
    "off_11_epa_rolling_w5",
    "off_12_epa_rolling_w5",
