...
|------|-------|---|-----|-------|---------|-------|-----------|
| 1 | off_11/12 + qb_off + def + pd + qbr + def_vs_12<br><sub>`off_11_epa_rolling`, `off_12_epa_rolling`, `qb_off_11_epa_rolling`, `qb_off_12_epa_rolling`, `def_epa_rolling`, `point_diff_rolling`, `qbr_rolling`, `def_vs_12_epa_rolling`</sub> | 644 | **55.9%** | **+43.3** | 56.2% | 324 | +23.5 |
| 2 | off_11/12 + qb_off + def + pd + qbr<br><sub>`off_11_epa_rolling`, `off_12_epa_rolling`, `qb_off_11_epa_rolling`, `qb_off_12_epa_rolling`, `def_epa_rolling`, `point_diff_rolling`, `qbr_rolling`</sub> | 644 | 55.1% | +33.7 | 54.9% | 319 | +15.1 |
| 3 | off_11/12 + qb_off + def + pd + qbr + cpoe + def_vs_12<br><sub>`off_11_epa_rolling`, `off_12_epa_rolling`, `qb_off_11_epa_rolling`, `qb_off_12_epa_rolling`, `def_epa_rolling`, `point_diff_rolling`, `qbr_rolling`, `cpoe_rolling`, `def_vs_12_epa_rolling`</sub> | 644 | 55.3% | +35.6 | **57.4%** | 319 | **+30.4** |
| 4 | off_11/12 + qb_off + def + pd + qbr + cpoe<br><sub>`off_11_epa_rolling`, `off_12_epa_rolling`, `qb_off_11_epa_rolling`, `qb_off_12_epa_rolling`, `def_epa_rolling`, `point_diff_rolling`, `qbr_rolling`, `cpoe_rolling`</sub> | 644 | 55.0% | +31.8 | 55.2% | 315 | +17.2 |
| 5 | off_11/12 + qb_off + def + pd + def_vs_12<br><sub>`off_11_epa_rolling`, `off_12_epa_rolling`, `qb_off_11_epa_rolling`, `qb_off_12_epa_rolling`, `def_epa_rolling`, `point_diff_rolling`, `def_vs_12_epa_rolling`</sub> | 645 | 54.9% | +30.8 | 56.3% | 318 | +23.7 |
| 6 | off_11/12 + qb_off + pd + qbr + def_vs_12<br><sub>`off_11_epa_rolling`, `off_12_epa_rolling`, `qb_off_11_epa_rolling`, `qb_off_12_epa_rolling`, `point_diff_rolling`, `qbr_rolling`, `def_vs_12_epa_rolling`</sub> | 644 | 54.7% | +28.0 | 57.2% | 320 | +29.4 |
| 7 | off_11/12 + qb_off + pd + qbr<br><sub>`off_11_epa_rolling`, `off_12_epa_rolling`, `qb_off_11_epa_rolling`, `qb_off_12_epa_rolling`, `point_diff_rolling`, `qbr_rolling`</sub> | 644 | 54.5% | +26.1 | 54.3% | 335 | +12.5 |
| 8 | off_11/12 + qb_off + pd + qbr + TO<br><sub>`off_11_epa_rolling`, `off_12_epa_rolling`, `qb_off_11_epa_rolling`, `qb_off_12_epa_rolling`, `point_diff_rolling`, `qbr_rolling`, `turnovers_committed_rolling`</sub> | 644 | 54.0% | +20.4 | 55.4% | 334 | +19.2 |
| 9 | off_11/12 + pd + qbr<br><sub>`off_11_epa_rolling`, `off_12_epa_rolling`, `point_diff_rolling`, `qbr_rolling`</sub> | 662 | 54.1% | +21.5 | 52.9% | 327 | +3.3 |
| 10 | off_11/12 + def + pd + qbr<br><sub>`off_11_epa_rolling`, `off_12_epa_rolling`, `def_epa_rolling`, `point_diff_rolling`, `qbr_rolling`</sub> | 662 | 53.3% | +11.9 | 53.3% | 334 | +5.8 |

### Top 10 by E>3 ATS (selective high-confidence bets)

| Rank | Model | N | ATS | Units | E>3 ATS | E>3 N | E>3 Units |
|------|-------|---|-----|-------|---------|-------|-----------|
| 1 | off_11/12 + qb_off + def + pd + qbr + cpoe + def_vs_12<br><sub>`off_11_epa_rolling`, `off_12_epa_rolling`, `qb_off_11_epa_rolling`, `qb_off_12_epa_rolling`, `def_epa_rolling`, `point_diff_rolling`, `qbr_rolling`, `cpoe_rolling`, `def_vs_12_epa_rolling`</sub> | 644 | 55.3% | +35.6 | **57.4%** | 319 | **+30.4** |
| 2 | off_11/12 + qb_off + pd + qbr + def_vs_12<br><sub>`off_11_epa_rolling`, `off_12_epa_rolling`, `qb_off_11_epa_rolling`, `qb_off_12_epa_rolling`, `point_diff_rolling`, `qbr_rolling`, `def_vs_12_epa_rolling`</sub> | 644 | 54.7% | +28.0 | 57.2% | 320 | +29.4 |
| 3 | off_11/12 + qb_off + def + pd + qbr + def_vs_12<br><sub>`off_11_epa_rolling`, `off_12_epa_rolling`, `qb_off_11_epa_rolling`, `qb_off_12_epa_rolling`, `def_epa_rolling`, `point_diff_rolling`, `qbr_rolling`, `def_vs_12_epa_rolling`</sub> | 644 | 55.9% | +43.3 | 56.2% | 324 | +23.5 |
| 4 | off_11/12 + qb_off + def + pd + def_vs_12<br><sub>`off_11_epa_rolling`, `off_12_epa_rolling`, `qb_off_11_epa_rolling`, `qb_off_12_epa_rolling`, `def_epa_rolling`, `point_diff_rolling`, `def_vs_12_epa_rolling`</sub> | 645 | 54.9% | +30.8 | 56.3% | 318 | +23.7 |
| 5 | off_11/12 + qb_off + pd + qbr + TO<br><sub>`off_11_epa_rolling`, `off_12_epa_rolling`, `qb_off_11_epa_rolling`, `qb_off_12_epa_rolling`, `point_diff_rolling`, `qbr_rolling`, `turnovers_committed_rolling`</sub> | 644 | 54.0% | +20.4 | 55.4% | 334 | +19.2 |
| 6 | off_11/12 + qb_off + def + pd + qbr + cpoe<br><sub>`off_11_epa_rolling`, `off_12_epa_rolling`, `qb_off_11_epa_rolling`, `qb_off_12_epa_rolling`, `def_epa_rolling`, `point_diff_rolling`, `qbr_rolling`, `cpoe_rolling`</sub> | 644 | 55.0% | +31.8 | 55.2% | 315 | +17.2 |
| 7 | off_11/12 + qb_off + def + pd + qbr<br><sub>`off_11_epa_rolling`, `off_12_epa_rolling`, `qb_off_11_epa_rolling`, `qb_off_12_epa_rolling`, `def_epa_rolling`, `point_diff_rolling`, `qbr_rolling`</sub> | 644 | 55.1% | +33.7 | 54.9% | 319 | +15.1 |
| 8 | off_11/12 + qb_off + pd + qbr<br><sub>`off_11_epa_rolling`, `off_12_epa_rolling`, `qb_off_11_epa_rolling`, `qb_off_12_epa_rolling`, `point_diff_rolling`, `qbr_rolling`</sub> | 644 | 54.5% | +26.1 | 54.3% | 335 | +12.5 |
| 9 | off_11/12 + def + pd + qbr<br><sub>`off_11_epa_rolling`, `off_12_epa_rolling`, `def_epa_rolling`, `point_diff_rolling`, `qbr_rolling`</sub> | 662 | 53.3% | +11.9 | 53.3% | 334 | +5.8 |
| 10 | off_11/12 + pd + qbr<br><sub>`off_11_epa_rolling`, `off_12_epa_rolling`, `point_diff_rolling`, `qbr_rolling`</sub> | 662 | 54.1% | +21.5 | 52.9% | 327 | +3.3 |

**Notable:** After fixing the QBR join (team-free key) and name normalization (C.J. Stroud double-initials, Penix Jr. suffix), plus treating 12-personnel features as optional (default 0 when missing), the full test set grew from 586 → 644 games for QBR-dependent models. The overall #1 (`off+def+pd+qbr+def_vs12`) holds its position at 55.9% / +43.3u. The E>3 leader is `off+def+pd+qbr+cpoe+def_vs12` at 57.4% / +30.4u — consistent with earlier results but on a larger, cleaner dataset.
