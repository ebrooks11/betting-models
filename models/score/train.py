...
OFF_COLS = ["points_scored_rolling", "qbr_rolling", "plays_per_game_rolling", "turnovers_committed_rolling", "top_rolling"]

# Defensive features (opponent's rolling stats)
DEF_COLS = ["turnovers_committed_rolling", "top_rolling"]
