"""
EPA + pace + TOP model: 3-game rolling EPA, plays per game, and time of possession.
...
FEATURE_COLS = ["off_epa_rolling", "def_epa_rolling", "plays_per_game_rolling", "top_rolling"]
