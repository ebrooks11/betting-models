"""
EPA + 1st down EPA + pace + QBR model.
Train 2015-2021, test 2022-2024.
Note: rows missing QBR (2024 season, backup QBs) are dropped via build_dataset dropna.
"""
...
FEATURE_COLS = ["off_epa_rolling", "def_epa_rolling", "off_epa_first_down_rolling", "def_epa_first_down_rolling", "plays_per_game_rolling", "qbr_rolling"]
